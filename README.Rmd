...
Warning messages:
  ...
  * **Specify what the guess the program made that is unsure about**.
  ...
  * If possible, **specify a probable and worst-case** outcome if this warning message were ignored.
